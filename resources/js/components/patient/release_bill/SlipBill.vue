    ...
    <div class="col-md-8 col-md-offset-2">
        <div class="row" style="margin-top:15px;">
            ...
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-xs-12 text-center">
                            <h5 style="text-decoration: underline;"><strong>Bill Details</strong></h5>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        getSearchResult(){
            axios.post('/get_slip_bill', {admissionId:this.id,status: 'Admitted',date:this.date}).then( res => {
                ...
                console.log(this.shift_days);
                console.log(this.admission_days);
                console.log(this.last_shift_days);
            });
        },
