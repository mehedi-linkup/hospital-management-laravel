...
<template>
  ...
  <div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
    ...
    <SlipBillPayment  v-bind:id="selectedAdmission.id !=null ? selectedAdmission.id : null"   v-bind:date="date" v-if="showSlipBill" />
...
import SlipBillPayment from "../release_bill/SlipBillPayment.vue";
export default {
    components: {
      SlipBillPayment
    },
