...
<template>
  ...
  <div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
    ...
    <br>
    <Issueinventoryinvoice  v-bind:id="selectedInvoice.id" v-if="showInvoice" />
...
import Issueinventoryinvoice from "../issue/IssueInventoryInvoice.vue";
export default {
    components: {
    ...
    methods: {
      getPurchases() {
        axios.post("/get_issue_inventory").then(res => {
