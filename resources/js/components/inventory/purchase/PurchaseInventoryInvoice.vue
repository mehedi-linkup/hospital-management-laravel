            ...
            <div class="col-md-12">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-5 text-right">
                        <strong>Purchase by:</strong> {{ purchase.user_name }}<br>
                        <strong>Invoice No.:</strong> {{ purchase.invoice_number }}<br>
                        <strong>Purchase Date:</strong> {{ purchase.order_date }} {{ purchase.created_at}}
                    </div>
                </div>
                 <div class="row">
                    <div class="col-xs-12">
                ...
                <div class="row">
                  <div class="col-xs-12">
                    <table _a584de>
                        ...
                        <tbody>
                            <tr v-for="(row, sl) in purchase.purchaseDetails" :key="sl">
                                <td>{{ sl + 1 }}</td>
                                ...
                                <td class="text-right">{{ row.total_amount.toFixed(2) }}</td>
                            </tr>
                        </tbody>
                     </table>
                    </div>
                    ...
                    <div class="col-xs-6">
                        <table _t92sadbc2 class="pull-right">
                            <tr>
                                ...
                                <td style="text-align:right">{{ purchase.subtotal.toFixed(2) }}</td>
                            </tr>
                            <tr>
                                <td><strong>VAT ({{ purchase.vat_percent }}%):</strong></td>
                                <td style="text-align:right">{{ purchase.vat_amount.toFixed(2) }}</td>
                            </tr>
                            <tr>
                                <td><strong>Discount ({{ purchase.discount_percent }}%):</strong></td>
                                <td style="text-align:right">{{ purchase.discount_amount.toFixed(2) }}</td>
                            </tr>
                            <tr>
                                <td><strong>Transport Cost:</strong></td>
                                <td style="text-align:right">{{ purchase.transport_cost.toFixed(2) }}</td>
                            </tr>
                            <tr><td colspan="2" style="border-bottom: 1px solid #ccc"></td></tr>
                            <tr>
                                <td><strong>Total:</strong></td>
                                <td style="text-align:right">{{ purchase.total.toFixed(2) }}</td>
                            </tr>
                            <tr>
                                <td><strong>Paid:</strong></td>
                                <td style="text-align:right">{{ purchase.paid.toFixed(2) }}</td>
                            </tr>
                            <tr><td colspan="2" style="border-bottom: 1px solid #ccc"></td></tr>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <strong>In Word: </strong> {{ convertNumberToWords(purchase.total) }}<br><br>
                        <strong>Note: </strong>
                        <p style="white-space: pre-line">{{ purchase.remark }}</p>
                    </div>
                </div>
                </div>
            </div>
