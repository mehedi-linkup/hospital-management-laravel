...
<template>
  ...
  <div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
    ...
    <br>
    <Purchaseinventoryinvoice  v-bind:id="selectedInvoice.id" v-if="showInvoice" />
...
import Purchaseinventoryinvoice from "../purchase/PurchaseInventoryInvoice.vue";
export default {
    components: {
        Purchaseinventoryinvoice
    },
    data() {
      return {
        invoices: [],
    ...
    methods: {
      getPurchases() {
        axios.post("/get_purchase_inventory").then(res => {
