            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-xs-12 text-center">
                        <div _h098asdh>
                            Inventory Purchase Return Invoice
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-xs-5 text-right">
                        <strong>Purchase by:</strong> {{ purchaseReturn.user_name }}<br>
                        <strong>Invoice No.:</strong> {{ purchaseReturn.invoice_number }}<br>
                        <strong>Purchase Date:</strong> {{ purchaseReturn.return_date }} {{ purchaseReturn.created_at}}
                    </div>
                </div>
                 <div class="row">
                    <div class="col-xs-12">
                ...
                <div class="row">
                  <div class="col-xs-12">
                    <table _a584de>
                        ...
                        <tbody>
                            <tr v-for="(row, sl) in purchaseReturn.purchaseReturnDetails" :key="sl">
                                <td>{{ sl + 1 }}</td>
                    ...
                    <div class="col-xs-6">
                        <table _t92sadbc2 class="pull-right">
                            <tr>
                                ...
                                <td style="text-align:right">{{ purchaseReturn.total_amount }}</td>
                            </tr>
                        </table>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        <strong>In Word: </strong> {{ convertNumberToWords(purchaseReturn.total_amount) }}<br><br>
                        <strong>Note: </strong>
                        <p style="white-space: pre-line">{{ purchaseReturn.remark }}</p>
                    </div>
                </div>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        getSearchResult(){
            axios.post('/get_purchase_return_inventory', {purchaseReturnId:this.id,with_details: true}).then( res => {
                this.purchaseReturn  = res.data[0];
