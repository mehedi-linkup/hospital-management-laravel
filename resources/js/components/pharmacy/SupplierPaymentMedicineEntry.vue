                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xs-7">
                                                <v-select :options="suppliers" class="select" v-model="selectedSupplier" label="display_name"></v-select>
                                            </div>
                                            <div class="col-xs-1" style="padding: 0; margin-left: -10px;">
...
export default {
    ...
    methods: {
        ...
        getSupplierPaymentTransaction(){
            axios.post('/get_supplierpaymentsmedicine',{date: this.supplierpayment.payment_date}).then(res=>{
                this.supplierpayments = res.data;
            })
        },
        getSupplierPaymentTransactionCode(){
            axios.get('/get_supplier_payment_medicine_code').then(res=>{
        ...
        save(){
            ...
            let url = '/store-supplierpayment-medicine';
            if(this.supplierpayment.id != ''){
                url = '/update-supplierpayment-medicine';
            }
            let data = {
        ...
        deleteSupplierPayment(id){
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios.post('/delete-supplierpayment-medicine', {id}).then(res=>{
                        let r = res.data;
                        Swal.fire({
                            icon: 'success',
                            title: r.message,
