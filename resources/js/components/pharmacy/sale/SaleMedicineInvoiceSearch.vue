<template>
  ...
  <div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
    ...
    <br>
    <SaleMedicineinvoice  v-bind:id="selectedInvoice.id" v-if="showInvoice" />
...
import SaleMedicineinvoice from "../sale/SaleMedicineInvoice.vue";
export default {
    components: {
      SaleMedicineinvoice
    },
    ...
    methods: {
      getSales() {
        axios.post("/get_sale_medicine").then(res => {
