    ...
    <div class="col-md-8 col-md-offset-2">
        <div class="row" style="margin-top:15px;">
            ...
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-xs-7">
                        <strong>Patient Id:</strong> {{ sale.patient_code }}<br>
                        <strong>Patient Name:</strong> {{ sale.patient_name }}<br>
                        <strong>Patient Address:</strong> {{ sale.patient_address }}<br>
                        <strong>Patient Mobile:</strong> {{ sale.patient_mobile }}
                    </div>
                    <div class="col-xs-5 text-right">
                        <strong>Sale by:</strong> {{ sale.user_name }}<br>
                        <strong>Invoice No.:</strong> {{ sale.invoice_number }}<br>
                        <strong>Sale Date:</strong> {{ sale.order_date }}  {{ sale.created_at}}
                    </div>
                </div>
                 <div class="row">
                    <div class="col-xs-12">
                ...
                <div class="row">
                  <div class="col-xs-12">
                    <table _a584de>
                        ...
                        <tbody>
                            <tr v-for="(row, sl) in sale.saleDetails" :key="sl">
                                <td>{{ sl + 1 }}</td>
                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-6">
                        <table _t92sadbc2 class="pull-right">
                            ...
                            <tr>
                                <td><strong>VAT ({{ sale.vat_percent }}%):</strong></td>
                                <td style="text-align:right">{{ sale.vat_amount }}</td>
                            </tr>
                            <tr>
                                <td><strong>Discount ({{ sale.discount_percent }}%):</strong></td>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <strong>In Word: </strong> {{ convertNumberToWords(sale.total) }}<br><br>
                        <strong>Note: </strong>
                        <p style="white-space: pre-line">{{ sale.remark }}</p>
                    </div>
                </div>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        getSearchResult(){
            axios.post('/get_sale_medicine', {salesId:this.id,with_details: true}).then( res => {
                ...
                <div class="container" style="width:95%;margin-top:80px;">
                    ...
                    <div style="position:fixed;left:0;bottom:15px;width:100%;">
                                <div class="row" style="font-size:12px;">
                                    <div class="col-xs-6">
                                        Print Date: ${moment().format('DD-MM-YYYY h:mm a')}, Printed by: ${this.sale.user_name}
                                    </div>
                                    <div class="col-xs-6 text-right">
